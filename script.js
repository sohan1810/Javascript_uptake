...
// The Conditional (Ternary) Operator are simmiliar to if else statment but all in one line
const age = 2;
age >= 18 ? console.log('I am adult') : console.log('I am Not adult');

// const result = age >= 18 ? 'adult' : 'Not adult ';//simpler or compact if else
// console.log(result);
...
// console.log(`I am ${age >= 18 ? 'adult' : 'Not adult '}`);
...
// javascript started 5_day revising all topics 